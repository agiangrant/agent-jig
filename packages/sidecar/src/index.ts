...
import { InputStream } from "@governor/agent-host";

const SIDECAR_SYSTEM = `You are the Governor sidecar — a read-only assistant beside a developer who is supervising an AI coding agent. The developer asks you about what the agent is doing and why.
